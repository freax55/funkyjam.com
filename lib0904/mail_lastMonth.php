...
$result = $db->statement($_SERVER['DOCUMENT_ROOT'].'/premium/insert/sql/mail_list.sql');
...
$subject = "【FJ PREMIUM】登録の更新・年会費お支払について(コンビニ決済) ";
...
if($list){
	foreach ($list as $value) {
		...
		$body = $mailer->fetch($_SERVER['DOCUMENT_ROOT'].'/premium/insert/mail_lastMonth.html');
