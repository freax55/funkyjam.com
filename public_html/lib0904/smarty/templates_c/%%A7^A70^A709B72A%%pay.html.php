<?php /* Smarty version 2.6.18, created on 2015-02-27 10:56:26
         compiled from artist/kubota/ticket/pay.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'artist/kubota/ticket/pay.html', 36, false),array('modifier', 'nl2br', 'artist/kubota/ticket/pay.html', 83, false),)), $this); ?>
...
<!--&nbsp;<input name="payment" type="radio" value="モバイル版FJSHOP 予約" <?php if ($this->_tpl_vars['payment'] == 'モバイル版FJSHOP 予約'): ?> checked="checked"<?php endif; ?> id="pay02" /><label for="pay02"><font color="#A4272C">[予約]</font></label><br />-->
<img src="/images/common/dot.gif" width="1" height="10" /><br />
<center>
...
<font color="#FF9E23">●</font><a href="#cardBBC">BARI BARI CREWカード決済</a><br />
<img src="/images/common/dot.gif" width="1" height="3" /><br />
<font color="#FF9E23">●</font><a href="#conveni">コンビニ決済</a><br />
<!--<img src="/images/common/dot.gif" width="1" height="3" /><br />
<font color="#FF9E23">●</font><a href="#yubin">予約</a><br />-->
<img src="/images/common/dot.gif" width="1" height="10" /><br />
<hr color="#EEEEEE" size="1" noshade="noshade" />
<a name="cardBBC"></a>
<center><font color="#FF9E23">◆</font>BARI BARI CREWカード決済<font color="#FF9E23">◆</font></center>
<font size="1">・一括払いのみのお取り扱いとなります。<br />
・引落時カードの有効期限が切れている場合、決済が出来ませんので<font color="#A4272C">お申込みは無効</font>となります。<br />
・BARI BARI CREWカード決済につきましては、システム上、お申込み完了時点でご購入確定とさせて頂きます。<br />
...
<!--<a name="yubin"></a>
<center><font color="#FF9E23">◆</font>予約<font color="#FF9E23">◆</font></center>
<font size="1">
予約テキスト<br />
</font>-->
<img src="/images/common/dot.gif" width="1" height="5" /><br />
