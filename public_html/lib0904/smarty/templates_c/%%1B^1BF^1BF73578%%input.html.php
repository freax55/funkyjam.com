<?php /* Smarty version 2.6.18, created on 2015-04-16 01:52:42
         compiled from shop/input.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'shop/input.html', 39, false),)), $this); ?>
...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#FAE9BA" width="100%">
	<tr>
		<td align="center"><img src="../images/common/dot.gif" width="1" height="3" /><br />お客様情報入力<br /><img src="../images/common/dot.gif" width="1" height="3" /></td>
	</tr>
</table>
...
<font color="#FF9E23">[FC会員番号]</font><?php if ($this->_tpl_vars['payment'] == "モバイル版FJSHOP BariBariCrewCARD"): ?>&nbsp;<font color="#A4272C">※必須</font><?php endif; ?><br />
...
<input type="text" istyle="4" MODE="numeric" name="tel1" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['tel1'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="5" maxlength="5" />-<input type="text" istyle="4" MODE="numeric" name="tel2" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['tel2'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="5" maxlength="5" />-<input type="text" istyle="4" MODE="numeric" name="tel3" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['tel3'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
