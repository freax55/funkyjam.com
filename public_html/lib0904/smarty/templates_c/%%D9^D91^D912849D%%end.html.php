<?php /* Smarty version 2.6.18, created on 2015-04-17 02:51:16
         compiled from shop/end.html */ ?>
...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#FAE9BA" width="100%">
	<tr>
		<td align="center"><img src="../images/common/dot.gif" width="1" height="3" /><br />お申込み完了<br /><img src="../images/common/dot.gif" width="1" height="3" /></td>
	</tr>
</table>
<img src="../images/common/dot.gif" width="1" height="10" /><br />

お申込みを承りました。<br />
ご記入いただきましたアドレスに、確認メールをお送りいたしました。<br />
<br />
なお、24時間以上経ってもメールが届かなかった場合はお手数ですが下記までご連絡ください。<br />
