...
class Net_inputAction extends ShopAction {
	function execute() {
		...
		$params['claim_kana'] = 'О╠О▒О▌О╖-О╝О▐О╘О╤О╝О╓О│О╦О▌О└О▐О▓О╖О▌';
		$params['claim_kanji'] = 'е╒ебеєенб╝е╕еуер╛ж╔╩┬х╢БE;
		$params['customer_family_name'] = $this->last_name;
		$params['customer_name'] = $this->first_name;
		$params['receipt_name_kana'] = 'О╠О▒О▌О╖-О╝О▐О╘О╤';
		$params['receipt_name'] = 'е╒ебеєенб╝е╕еуеБE;
