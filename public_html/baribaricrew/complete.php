...
class Action extends DatabaseAction {
	...
	function prepare() {
		$this->_subject = '購入内容のご確認(コンビニ・年会費)';
		//$this->_system_name = 'FJ SHOPメールオーダー';
		//$this->_system_mail = 'shop@funkyjam.com';
		//$this->_other_mail = 'shop@funkyjam.com';
		$this->_system_name = 'BARI BARI CREW 年会費';
		$this->_system_mail = 'kaihi_kubota@funkyjam.com';
		$this->_other_mail = 'kaihi_kubota@funkyjam.com';
		$this->_other_mail_code = 'A013';

		//$this->confirm_mail = 'saita@evol-ni.com';
	...
	function execute() {
		...
		elseif ($row['payment'] == "コンビニ決済") {
			...
			$body = $mailer->fetch('baribaricrew/mail_paygent_cvs.html');
			$body = $this->convertEncodingBody($body);
