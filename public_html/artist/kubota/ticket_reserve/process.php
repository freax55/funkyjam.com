...
class Action extends ShopAction {
	function init() {
		...
		define('RET_URL', 'https://www.funkyjam.com/artist/kubota/ticket_reserve/index.php?action=complete&');
	...
	function addOrder(){
		...
		$this->dbBigen();
		$this->dbExec('artist/kubota/ticket_reserve/sql/lock_table.sql');
		$this->p04 = $this->getNextOrderNo();
		foreach($this->cart as $value){
			$this->item = $value;
			$this->dbExec('artist/kubota/ticket_reserve/sql/insert_order.sql');
		}
		$this->dbExec('artist/kubota/ticket_reserve/sql/insert_order_desc.sql');
		$this->dbCommit();
	}
	...
	function getPaymentLimitDate($password) {
		...
		// // 8/13(火)23：59までの受付分
		// $end1 = mktime(23, 59, 59, 8, 13, 2013);
		// // 8/14(金)0：00ー15(土)23：59受付分
		// $end2 = mktime(23, 59, 59, 8, 15, 2013);
		// // 8/29(木)23：59までの受付分
		// $end3 = mktime(23, 59, 59, 8, 29, 2013);
		// // 8/30(金)0：00ー31(土)23：59受付分
		// $end4 = mktime(23, 59, 59, 8, 31, 2013);

		// if($now<$end1){
		// 	$limit = mktime(23, 59, 59, 8, 15, 2013);
		// }elseif($now<$end2){
		// 	$limit = mktime(23, 59, 59, 8, 17, 2013);
		// }elseif($now<$end3){
		// 	$limit = mktime(23, 59, 59, 8, 31, 2013);
		// }elseif($now<$end4){
		// 	$limit = mktime(23, 59, 59, 9, 2, 2013);
		// }
