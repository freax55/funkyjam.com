...
class GoodsMaintenanceController extends MaintenanceController
{
	...
	function GoodsMaintenanceController() {
		...
		$this->_base_dir = 'admin/item/goods/fjshop/';

		$this->tableName = '"item"';
		$this->keyName = 'item_code';
//		$this->order = 'category_code, to_number(inquiries_tel, \'00000\'), c_stamp desc';
	...
	function setCategoryList() {
		...
		$where = "category_code <> 'A013' and kind = '" . $this->_categoryKind . "'";
