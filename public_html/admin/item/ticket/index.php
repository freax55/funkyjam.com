...
class TicketMaintenanceController extends MaintenanceController
{
	var $td = null;
	var $uploadList = null;
...
//	var $stock = null;
	...
	var $_categoryKind = 'ticket';
	var $categoryList = null;
	var $placeList = null;
	var $areaList = null;

	function TicketMaintenanceController() {
		$this->MaintenanceController();

		$this->_base_dir = 'admin/item/ticket/';

		$this->tableName = '"item"';
		$this->keyName = 'item_code';
		$this->order = 'p_date desc';
...
//		if (!$_REQUEST['action']) {
//			$ret = $this->redirectToURL(dirname($_SERVER['PHP_SELF']) . '/build.php');
//			return $ret;
//		}
	
		return MaintenanceController::executeList();
	}
...
//		}
		...
		$rec->addString('inquiries_tel', $this->inquiries_tel);
		return $rec;
	}
...
$controller = new TicketMaintenanceController();
$controller->process();
